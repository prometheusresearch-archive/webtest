...
var _concatMapPromise = require('./concatMapPromise');

var _concatMapPromise2 = _interopRequireDefault(_concatMapPromise);
    ...
    return _regeneratorRuntime.async(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          ...
          context$2$0.next = 5;
          return (0, _concatMapPromise2['default'])(find, entry);
